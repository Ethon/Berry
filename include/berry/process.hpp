...
namespace berry
{
  ...
  public:
    ...
    /**
     * @brief Constructs a process object from an entry.
     *
     * @param entry The target process entry.
     **/
    explicit process(process_entry const& entry);
  ...
  **/
  bool still_exists(process const& proc);
  ...
  namespace unix_like
  {
    ...
    **/
    boost::filesystem::path get_procfs_dir(process const& proc);
  }
  ...
  **/
  boost::filesystem::path get_working_dir(process const& proc);
  ...
  **/
  boost::filesystem::path get_executable_path(process const& proc);
  ...
  **/
  int get_bitness(process const& proc);
  ...
  **/
  ...
  /**
   * @brief Kills the specified process. 
   ...
   **/
  void kill_process(process const& proc, int exit_code = 0);
}
